...
1. 首先以maven为例，在maven的配置文件里面加入插件
    ...
    ![](http://mzvast.github.io/picorz-img/Picorz-pasteshot--2017-03-22T202000+0800)
...
2. 在idea的设置中开启自动编译(Compiler->Build project automatically)
    ...
    ![](http://mzvast.github.io/picorz-img/Picorz-pasteshot--2017-03-22T201155+0800)

3. 在idea的registry里面开启允许运行时自动编译

    用快捷键`Shift+Ctrl+P`调出搜索框，键入`registry`并回车
    ![](http://mzvast.github.io/picorz-img/Picorz-pasteshot--2017-03-22T201320+0800)

    然后滚动到这个`compiler.automake.allow.when.app.running`，打勾保存。
    ![](http://mzvast.github.io/picorz-img/Picorz-pasteshot--2017-03-22T201449+0800)
